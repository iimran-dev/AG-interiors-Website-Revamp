            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-2.5">
              {CATEGORIES.map((category) => (
                <button
                  ...
                  className={`text-xs font-sans tracking-wider py-1.5 px-3.5 rounded-full transition-all duration-300 ${
                    activeCategory === category
                      ? "bg-[#1E1E1E] text-white font-medium shadow-sm"
                      : "bg-white/80 text-[#6B655B] hover:text-[#1E1E1E] hover:bg-[#ECE6DC] border border-[#E2DBD0]"
                  }`}
                >
                  {category}
                </button>
