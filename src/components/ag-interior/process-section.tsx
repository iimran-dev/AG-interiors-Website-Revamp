  ...
  return (
    <section id="process" className="py-16 sm:py-24 lg:py-28 bg-[#FAF8F5] border-t border-[#ECE7DF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-6 lg:gap-4 relative">
          {PROCESS_STEPS.map((item, index) => (
            <div
              key={item.step}
              className="flex flex-col relative group bg-white/50 lg:bg-transparent p-5 lg:p-0 rounded-xl lg:rounded-none border border-[#EAE3D5] lg:border-none shadow-sm lg:shadow-none"
            >
              ...
              {/* Title & Description */}
              <h3 className="font-display text-base sm:text-lg font-medium text-[#1E1E1E] mb-1.5">
                {item.title}
              </h3>
